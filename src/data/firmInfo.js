export const FIRM_INFO = {
  ...
  stats: [
    { label: "Years of Excellence", value: "16+", description: "Delivering trusted advisory since inception" },
    { label: "Expert Partners", value: "4", description: "Complementary expertise across audit & tax" },
    { label: "Standards Expertise", value: "US GAAP & IND AS", description: "Global & Indian accounting compliance" },
    { label: "Client Presence", value: "PAN India", description: "Serving MNCs, Listed & Private Enterprises" }
  ],
    ...
    pillars: [
      {
        ...
        description: "Unwavering commitment to professional standards, objectivity, and transparent governance in all assignments."
      },
      {
        title: "Technical Excellence",
        description: "Deep domain knowledge across US GAAP, IND AS, IFRS, Direct & Indirect Taxes, and statutory compliances."
      },
      {
        title: "Client Responsiveness",
        description: "Agile, accessible partner-led engagement providing prompt, practical solutions tailored to business needs."
      },
      {
        title: "Strategic Partnership",
        description: "Looking beyond compliance to add measurable value at every growth stage, from setup to IPO."
      }
    ]
  },
  ...
  offices: [
    ...
    {
      city: "Deoghar Office (Jharkhand)",
      address: "Shanti Nagar, Deoghar, Jharkhand 814112",
      phone: "+91 7042631642",
      email: "cankjain2009@gmail.com"
    }
  ]
